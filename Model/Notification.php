...
use Dsync\Dsync\Api\Data\NotificationInterface;

/**
 * Notification class
 */
class Notification extends AbstractModel implements IdentityInterface, NotificationInterface
{
    const CACHE_TAG = 'dsync_dsync_notification';
    ...
    {
        $this->_init('Dsync\Dsync\Model\ResourceModel\Notification');
    }
